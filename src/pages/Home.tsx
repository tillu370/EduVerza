    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-6 py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/about">
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 sketchy-border font-bold font-display">
                How It Works
              </Button>
            </Link>
          </div>
      ...
      <section className="container mx-auto px-6 py-12 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto relative z-10">
          <Card className="p-8 text-center sketchy-border sketchy-shadow bg-card hover:rotate-[-1deg] transition-transform paper-texture relative overflow-visible">
            <div className="doodle-decoration -top-2 -right-2">
              <div className="doodle-circle"></div>
            </div>
            <FileText className="h-12 w-12 text-primary mx-auto mb-4" />
            <div className="text-4xl font-bold mb-2 font-display text-navy">1,200+</div>
          ...
          <Card className="p-8 text-center sketchy-border sketchy-shadow bg-card hover:rotate-[1deg] transition-transform paper-texture relative overflow-visible">
            ...
            <div className="text-4xl font-bold mb-2 font-display text-navy">5,000+</div>
          ...
          <Card className="p-8 text-center sketchy-border sketchy-shadow bg-card hover:rotate-[-1deg] transition-transform paper-texture relative overflow-visible">
            ...
            <div className="text-4xl font-bold mb-2 font-display text-navy">800+</div>
      ...
      <section className="container mx-auto px-6 py-16 relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 hand-heading text-navy font-display">
            WHY EDUVERZA?
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 sketchy-border bg-card paper-texture">
              <div className="h-16 w-16 rounded-lg bg-primary/20 flex items-center justify-center sketchy-border mb-4">
                <Users className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-2xl font-bold mb-3 font-display">Student-Centered</h3>
            ...
            <Card className="p-8 sketchy-border bg-card paper-texture">
              ...
              <h3 className="text-2xl font-bold mb-3 font-display">Easy Upload</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-8 sketchy-border bg-card paper-texture">
              ...
              <h3 className="text-2xl font-bold mb-3 font-display">Organized Library</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-8 sketchy-border bg-card paper-texture">
              ...
              <h3 className="text-2xl font-bold mb-3 font-display">Always Growing</h3>
              <p className="text-muted-foreground">
