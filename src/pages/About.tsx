      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 hand-heading text-navy font-display">
              ABOUT EDUVERZA
            </h1>
          ...
          <Card className="p-8 mb-8 sketchy-border paper-texture">
            <h2 className="text-3xl font-bold mb-4 font-display text-navy">OUR MISSION</h2>
          ...
          <h2 className="text-4xl font-bold mb-8 text-center hand-heading text-navy font-display">
            WHAT MAKES US SPECIAL
          </h2>

          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <Card className="p-8 sketchy-border hover:rotate-[-0.5deg] transition-transform paper-texture">
            ...
            <Card className="p-8 sketchy-border hover:rotate-[0.5deg] transition-transform paper-texture">
              ...
              <h3 className="text-2xl font-bold mb-3 font-display">COMMUNITY DRIVEN</h3>
              <p className="text-muted-foreground">
          ...
          <Card className="p-8 sketchy-border sketchy-shadow bg-primary/10 paper-texture">
            <h2 className="text-3xl font-bold mb-4 text-center font-display text-navy">
              JOIN THE COMMUNITY
            </h2>
