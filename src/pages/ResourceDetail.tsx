      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h1 className="text-4xl font-bold mb-4 hand-heading text-navy font-display">
                {resource.title}
              </h1>
            ...
            {/* Preview Area */}
            <Card className="p-8 mb-6 sketchy-border bg-muted/20">
            ...
            <div className="flex gap-4 mb-8">
              <Button 
                className="flex-1 sketchy-shadow bg-primary hover:bg-primary-dark"
              ...
              <Button variant="outline" className="sketchy-border">
            ...
            {/* About Section */}
            <Card className="p-6 sketchy-border paper-texture">
              <h2 className="text-2xl font-bold mb-4 font-display">ABOUT THIS RESOURCE</h2>
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 sketchy-border sticky top-24 paper-texture">
              <h3 className="text-xl font-bold mb-4 font-display text-navy">DETAILS</h3>
